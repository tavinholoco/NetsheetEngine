...
export const PRD_DOCUMENT: PrdDocument = {
  ...
  roadmap: [
    ...
    },
    {
      ...
      status: 'pendente',
      tasks: [
        { code: 'T1.1', title: 'Reescrever checkIsGm() sem fallback permissivo', status: 'pendente' },
        { code: 'T1.2', title: 'updateTacticalGrid() exige GM legítimo', status: 'pendente' },
        { code: 'T1.3', title: 'Validação estrita de GM em NPCs/settings/initiative', status: 'pendente' },
        { code: 'T1.4', title: 'Rate limit nos endpoints /api/rooms/*', status: 'pendente' },
        { code: 'T1.5', title: 'Sanitização de handle/text/code', status: 'pendente' },
        { code: 'T1.6', title: 'Teste manual GM vs jogador', status: 'pendente' },
        { code: 'T1.7', title: 'Token de sessão anti-impersonificação por peerId', status: 'pendente' },
        { code: 'T1.8', title: 'Tratamento de GM que abandona a sala', status: 'pendente' }
      ]
    },
    {
      id: 'fase-2',
      ...
      status: 'pendente',
      tasks: [
        { code: 'T2.1', title: 'Supabase CLI + ambiente local', status: 'pendente' },
        { code: 'T2.2', title: 'Projeto Supabase na nuvem (.env.local)', status: 'pendente' },
        { code: 'T2.3', title: 'Instalar @supabase/supabase-js', status: 'pendente' },
        { code: 'T2.4', title: 'Migration SQL inicial (profiles, friendships, messages, sheets)', status: 'pendente' },
        { code: 'T2.5', title: 'RLS + índices em todas as tabelas', status: 'pendente' },
        { code: 'T2.6', title: 'Trigger on auth.users insert (cyberpunk_id)', status: 'pendente' },
        { code: 'T2.7', title: 'Realtime para mensagens e presença', status: 'pendente' },
        { code: 'T2.8', title: 'Provedores: Email/Senha + Google OAuth', status: 'pendente' },
        { code: 'T2.9', title: 'Migração de usuários/fichas (se houver)', status: 'pendente' },
        { code: 'T2.10', title: 'src/lib/supabase.ts com mesma API do firebase.ts', status: 'pendente' },
        ...
        { code: 'T2.16', title: 'Bucket avatars com RLS', status: 'pendente' },
