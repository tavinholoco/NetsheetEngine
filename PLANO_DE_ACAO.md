...
| 3 | Multiplayer: persistência | 🔄 em andamento (T3.1–T3.4) | — |
...
**Última atualização:** 08/08/2026 — **revisão v1.11**: Fases 0, 1 e **2 concluídas** (T2.1–T2.20; T2.9 cancelada). **Fase 3 em andamento** — T3.1–T3.4 concluídas (persistência de salas em `rooms.room_state jsonb` com service-role, debounce 2s, restauração no boot, shutdown gracioso, **reconexão com mesmo peerId** com ficha preservada e 1 token por jogador, e **timeout de isOnline** com heartbeat do cliente + broadcast ao vivo; decisão T3.5: **JSON simples**, documentada).
