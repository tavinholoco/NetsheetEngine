...
| 3 | Multiplayer: persistência | 🔄 em andamento (T3.1/T3.2/T3.3) | — |
...
**Última atualização:** 08/08/2026 — **revisão v1.10**: Fases 0, 1 e **2 concluídas** (T2.1–T2.20; T2.9 cancelada). **Fase 3 em andamento** — T3.1/T3.2/T3.3 concluídas (persistência de salas em `rooms.room_state jsonb` com service-role, debounce 2s, restauração no boot, shutdown gracioso e **reconexão com mesmo peerId**: ficha persistida preservada, 1 token por jogador, auto-re-join no cliente após restart; decisão T3.5: **JSON simples**, documentada).
